    ...
    return <div>
        <div className="bs_navbar">
            ...
            <ul>
                ...
                <li><a href="/stationed_store" style={{ color: "#B3E24D" }}>店家進駐</a></li>
        ...
        <div className="bs_aside">
            <ul>
                <li><a href="#">申請中店家</a></li>
                <li><a href="#">進駐中店家</a></li>
                <li><a href="#">已退租店家</a></li>
                <li><a href="#">已取消申請</a></li>
            </ul>
